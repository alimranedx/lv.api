...
class Str
{
   ...
   public static function toArr($string, $delimiter):array
   {
	...
	public static function toLower($string):string|null
	{
		if($string){
	...
	public static function toUpper($string):string|null
   {
	   if($string){
  ...
  public static function sprintf($format, $value) : string
  {
  ...
  {
      return str_slug($text, $separator);
  }

    public static function generateRandomString (int $length = 16, string $keyspace = ''): string
    {
